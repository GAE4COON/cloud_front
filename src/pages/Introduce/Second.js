      ...
      <SecondContainer ref={imageRef} inView={imageInView}>
        ...
        <CloudContainer>
            <IntroduceContainer>
                ...
                <TextTitleContent>OnCloud를 통해 클라우드 환경에 빠르게 적응해보세요!</TextTitleContent>
            </IntroduceContainer>
        </CloudContainer>
        ...
        <FlexContainer>
            <TextContainer>
                <TextContent>
                OnCloud는 사전으로 보안성이 점검된 아키텍처를 제시합니다. 이를 통해 기업은 보안 사고 발생에 대한 우려를 줄일 수 있습니다                </TextContent>
            </TextContainer>
        ...
        <FlexContainer>
            ...
            <TextContainer>
                <TextContent>
                OnCloud는 다양한 가이드 기능을 제공합니다. 보안 권고 및 가이드를 통한 보안 전략 수립, 리소스 가이드를 통한 클라우드 관리 역량 향상으로 클라우드 환경에 대비할 수 있습니다.
              </TextContent>
            </TextContainer>
        </FlexContainer>
        </SecondContainer>
